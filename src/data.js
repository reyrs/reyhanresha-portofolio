...
export const skillsData = {
  ...
  Backend: [
    { name: "Laravel", icon: "/assets/tools/laravel.svg", color: "red" },
    { name: "Node.js", icon: "/assets/tools/nodejs.png", color: "green" },
    { name: "Express.js", icon: "/assets/tools/express.svg", color: "gray" },
    { name: "PHP", icon: "/assets/tools/php.png", color: "purple" },
  ],
  "AI & Chatbot": [
    { name: "Python", icon: "/assets/tools/python.svg", color: "yellow" },
    { name: "OpenClaw", icon: null, color: "green" },
    { name: "Telegram Bot API", icon: "/assets/tools/telegram.svg", color: "blue" },
  ],
  Database: [
    { name: "MySQL", icon: "/assets/tools/mysql.png", color: "blue" },
    { name: "MongoDB", icon: "/assets/tools/mongodb.svg", color: "green" },
    { name: "Firebase", icon: "/assets/tools/firebase.png", color: "yellow" },
    { name: "Supabase", icon: "/assets/tools/supabase.svg", color: "green" },
  ],
  Tools: [
    { name: "Git", icon: "/assets/tools/git.svg", color: "orange" },
    { name: "GitHub", icon: "/assets/tools/github.png", color: "white" },
    { name: "Postman", icon: "/assets/tools/postman.svg", color: "orange" },
    { name: "Vercel", icon: "/assets/tools/vercel.svg", color: "white" },
    { name: "Laragon", icon: "/assets/tools/laragon.svg", color: "green" },
  ],
};
